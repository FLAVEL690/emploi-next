...
import { FiTrash2, FiEye, FiRefreshCw, FiUsers, FiTarget, FiEdit } from 'react-icons/fi';
                  ...
                  <tr key={job.id}>
                    ...
                    <td>
                      <div className="table-actions">
                        ...
                        <Link to={`/recruiter/post-job?edit=${job.id}`} className="action-btn" title="Modifier l'offre"><FiEdit /></Link>
